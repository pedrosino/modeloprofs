...
ToolTip(entrada_CH_MIN,
    msg="Valor da carga horária míima. Para valores não inteiros, use ponto decimal.", delay=0.1)
...
ToolTip(checkbox_maxima, msg="Ativar restrição de carga horária média máxima",
        delay=0.1)
